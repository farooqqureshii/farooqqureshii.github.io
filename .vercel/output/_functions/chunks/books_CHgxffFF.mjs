const books = [
  ...
  { title: "The Memory Police", author: "Yoko Ogawa", rating: 4, description: "Classic dystopian novel, predictable but engaging.", image: "https://covers.openlibrary.org/b/isbn/9781101870600-M.jpg" },
  { title: "The Man in the High Castle", author: "Philip K. Dick", rating: 5, description: "Illuminating, thought provoking alternate history.", image: "https://i.postimg.cc/DZZMhL55/9780544916081-large.webp" },
  ...
  { title: "The Handmaid's Tale", author: "Margaret Atwood", rating: 5, description: "Dystopian masterpiece that feels more relevant with each passing year. Atwood's world-building is chilling.", image: "https://covers.openlibrary.org/b/isbn/9780385490818-M.jpg" },
  { title: "Station Eleven", author: "Emily St. John Mandel", rating: 4, description: "Beautiful post-apocalyptic novel about art, connection, and what endures. Haunting and hopeful.", image: "https://covers.openlibrary.org/b/isbn/9780385353304-M.jpg" },
  { title: "The Underground Railroad", author: "Colson Whitehead", rating: 5, description: "Brilliant reimagining of history. Whitehead's prose is sharp and the story is unforgettable.", image: "https://covers.openlibrary.org/b/isbn/9780385542364-M.jpg" },
  { title: "Normal People", author: "Sally Rooney", rating: 4, description: "Intimate portrait of a relationship over years. Rooney captures the complexity of connection.", image: "https://covers.openlibrary.org/b/isbn/9780571334650-M.jpg" },
  { title: "The Seven Husbands of Evelyn Hugo", author: "Taylor Jenkins Reid", rating: 4, description: "Compelling story of old Hollywood glamour and secrets. Page-turner with depth.", image: "https://covers.openlibrary.org/b/isbn/9781501139239-M.jpg" },
  { title: "Circe", author: "Madeline Miller", rating: 4, description: "Beautiful retelling of Greek mythology from a fresh perspective. Miller brings ancient stories to life.", image: "https://covers.openlibrary.org/b/isbn/9780316556347-M.jpg" },
  { title: "The Overstory", author: "Richard Powers", rating: 4, description: "Epic novel about trees and our connection to nature. Ambitious and beautifully written.", image: "https://covers.openlibrary.org/b/isbn/9780393356687-M.jpg" },
  { title: "Exit West", author: "Mohsin Hamid", rating: 4, description: "Poetic and timely novel about migration and displacement. Hamid's magical realism is subtle and powerful.", image: "https://covers.openlibrary.org/b/isbn/9780241979068-M.jpg" },
  { title: "The Goldfinch", author: "Donna Tartt", rating: 4, description: "Sweeping coming-of-age story about art, loss, and obsession. Tartt's prose is immersive.", image: "https://covers.openlibrary.org/b/isbn/9780316055437-M.jpg" },
  { title: "The Sympathizer", author: "Viet Thanh Nguyen", rating: 5, description: "Brilliant spy novel about the Vietnam War. Sharp, darkly funny, and deeply insightful.", image: "https://covers.openlibrary.org/b/isbn/9780802123459-M.jpg" },
  { title: "Lincoln in the Bardo", author: "George Saunders", rating: 4, description: "Experimental and moving novel about grief and loss. Saunders' unique voice shines.", image: "https://covers.openlibrary.org/b/isbn/9780812995343-M.jpg" },
  { title: "The Sellout", author: "Paul Beatty", rating: 4, description: "Satirical masterpiece about race in America. Darkly funny and uncomfortably relevant.", image: "https://covers.openlibrary.org/b/isbn/9780374260507-M.jpg" },
  { title: "The Brief Wondrous Life of Oscar Wao", author: "Junot Díaz", rating: 5, description: "Vibrant and heartbreaking story of a Dominican family. Díaz's voice is electric.", image: "https://covers.openlibrary.org/b/isbn/9781594483295-M.jpg" },
  { title: "White Teeth", author: "Zadie Smith", rating: 4, description: "Multigenerational saga about immigration and identity in London. Smith's debut is ambitious and funny.", image: "https://covers.openlibrary.org/b/isbn/9780375703867-M.jpg" },
  { title: "The Kite Runner", author: "Khaled Hosseini", rating: 4, description: "Powerful story of friendship, betrayal, and redemption set in Afghanistan. Emotionally resonant.", image: "https://covers.openlibrary.org/b/isbn/9781594480003-M.jpg" },
  { title: "The Namesake", author: "Jhumpa Lahiri", rating: 4, description: "Beautiful novel about identity and belonging. Lahiri's exploration of the immigrant experience is masterful.", image: "https://covers.openlibrary.org/b/isbn/9780395927212-M.jpg" },
  { title: "The Remains of the Day", author: "Kazuo Ishiguro", rating: 5, description: "Perfect novel about duty, regret, and the things left unsaid. Ishiguro's restraint is devastating.", image: "https://covers.openlibrary.org/b/isbn/9780571152230-M.jpg" },
  { title: "Never Let Me Go", author: "Kazuo Ishiguro", rating: 5, description: "Haunting dystopian novel about memory, love, and what it means to be human. Subtle and profound.", image: "https://covers.openlibrary.org/b/isbn/9780571224142-M.jpg" },
  { title: "The Road", author: "Cormac McCarthy", rating: 5, description: "Bleak and beautiful post-apocalyptic journey. McCarthy's prose is spare and devastating.", image: "https://covers.openlibrary.org/b/isbn/9780307387899-M.jpg" },
  { title: "Blood Meridian", author: "Cormac McCarthy", rating: 4, description: "Brutal and brilliant western. McCarthy's vision of violence is unflinching and unforgettable.", image: "https://covers.openlibrary.org/b/isbn/9780679728757-M.jpg" },
  { title: "Beloved", author: "Toni Morrison", rating: 5, description: "Haunting masterpiece about slavery's legacy. Morrison's prose is poetic and powerful.", image: "https://covers.openlibrary.org/b/isbn/9781400033416-M.jpg" },
  { title: "The Color Purple", author: "Alice Walker", rating: 5, description: "Powerful epistolary novel about resilience and sisterhood. Walker's voice is unforgettable.", image: "https://covers.openlibrary.org/b/isbn/9780151191536-M.jpg" },
  { title: "One Hundred Years of Solitude", author: "Gabriel García Márquez", rating: 5, description: "Magical realism at its finest. Márquez creates a world that feels both fantastical and deeply human.", image: "https://covers.openlibrary.org/b/isbn/9780060883287-M.jpg" },
  { title: "The Stranger", author: "Albert Camus", rating: 4, description: "Existentialist classic about alienation and absurdity. Camus' spare prose is deceptively simple.", image: "https://covers.openlibrary.org/b/isbn/9780679720201-M.jpg" },
  { title: "The Great Gatsby", author: "F. Scott Fitzgerald", rating: 5, description: "Perfect American novel about the American Dream. Fitzgerald's prose is luminous and tragic.", image: "https://covers.openlibrary.org/b/isbn/9780743273565-M.jpg" },
...
export { books as a, booksToSavedItems as b };
